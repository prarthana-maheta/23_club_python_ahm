...
# # # # print(" ".join(s8))
# # #
# s6 = 'ssssssssssssssssss   students         of this batch are going batch are to rock the indian software industry!         '
...
# s8 = "$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$Happy$$Birthday!$$$$$$$$$$$$$$$$$"
# # #
# print(s8.replace("$", " ").strip())
# print(s8.replace("$", " ").replace(" ",""))
# #
# # """
# #
# # s8 = "$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$Happy$$Birthday!$$$$$$$$$$$$$$$$$"
...
numbers = [33,12, 0, -125, 44, 33, '[4][''791234', -5592, 33,(1j+1),[1,2]]
# s1=str(numbers)
# print(s1[0])

# print(numbers[5])
# print(numbers[6][0])
# print(type(numbers[6][0]))
# # index     0  1    2     3   4
# #          -9 -8    -7
# print(len(numbers))
# # print(type(numbers))
